 ...
 */
final class Version20230829135704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recherche_immeuble ADD data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recherche_immeuble DROP data');
    }
}
